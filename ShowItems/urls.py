...
urlpatterns = [
    path('',                                 views.showItems,  name=MenuOption.ITEMS),
    path('<menuOpt>',                        views.showItems,  name=MenuOption.ITEMS),
    path('addFilter/<menuOpt>/<addFilter>',  views.showItems,  name=MenuOption.ITEMS),        
]
