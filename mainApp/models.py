...
class SiteSettings( SingletonModel ):
    ...
    cartExpiryTime = models.PositiveIntegerField(
        default = 15, 
        verbose_name = 'Shopping Carts expiry time (in days)'
    )
    siteLanguage = models.CharField(
        max_length = 10,
        blank = False,
        default = ENGLISH,
        choices = LANGUAGE_CHOICES,
        verbose_name = _('Site Language'),
        help_text = _('Select the language of your Site')
    )
    emailHost = models.CharField(
        max_length = 100, 
        default = '', 
        blank = True, 
        verbose_name = 'Email Host'
    )
    emailHostUser = models.CharField(
        max_length = 100, 
        default = '', 
        blank = True, 
        verbose_name = 'Email Host User'
    )
    emailHostPassword = models.CharField(
        max_length = 50, 
        default = '', 
        blank = True, 
        verbose_name = 'Email Host Password'
    )
    emailPort = models.PositiveIntegerField(
        default = 587, 
        blank = True, 
